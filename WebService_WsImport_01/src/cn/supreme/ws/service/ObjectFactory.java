 ...
 * generated in the cn.supreme.ws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://service.ws.supreme.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.ws.supreme.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.supreme.ws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.supreme.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.supreme.cn/", name = "queryWeatherResponse")
