 ...
 * 2018-12-04T07:49:34.983+08:00
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://127.0.0.1:8080/WebService_Spring_CXF/ws/weather?wsdl",
...
public class WeatherInterfaceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:8080/WebService_Spring_CXF/ws/weather?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherInterfaceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:8080/WebService_Spring_CXF/ws/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
